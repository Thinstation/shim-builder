...
<title>sdt.h · main · Arch Linux / Packaging / Packages / glibc · GitLab</title>
<script>
//<![CDATA[
...
gl.startup_graphql_calls = [{"query":"query getBlobInfo(\n  $projectPath: ID!\n  $filePath: String!\n  $ref: String!\n  $refType: RefType\n  $shouldFetchRawText: Boolean!\n) {\n  project(fullPath: $projectPath) {\n    __typename\n    id\n    repository {\n      __typename\n      empty\n      blobs(paths: [$filePath], ref: $ref, refType: $refType) {\n        __typename\n        nodes {\n          __typename\n          id\n          webPath\n          name\n          size\n          rawSize\n          rawTextBlob @include(if: $shouldFetchRawText)\n          fileType\n          language\n          path\n          blamePath\n          editBlobPath\n          gitpodBlobUrl\n          ideEditPath\n          forkAndEditPath\n          ideForkAndEditPath\n          codeNavigationPath\n          projectBlobPathRoot\n          forkAndViewPath\n          environmentFormattedExternalUrl\n          environmentExternalUrlForRouteMap\n          canModifyBlob\n          canCurrentUserPushToBranch\n          archived\n          storedExternally\n          externalStorage\n          externalStorageUrl\n          rawPath\n          replacePath\n          pipelineEditorPath\n          simpleViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n          richViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n        }\n      }\n    }\n  }\n}\n","variables":{"projectPath":"archlinux/packaging/packages/glibc","ref":"main","refType":"HEADS","filePath":"sdt.h","shouldFetchRawText":true}}];
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"K6f80lkmiIhGURj0_SnX0_fMqKiCeBr0dUe8J8KQCEoc9E98qwAvG_qnU7-e7tfTh7eeFfsbP6KTj-Hh3fDWOQ","x-gitlab-feature-category":"source_code_management"};
...
<meta content="sdt.h · main · Arch Linux / Packaging / Packages / glibc · GitLab" property="og:title">
...
<meta content="https://gitlab.archlinux.org/archlinux/packaging/packages/glibc/-/blob/main/sdt.h?ref_type=heads" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="sdt.h · main · Arch Linux / Packaging / Packages / glibc · GitLab" property="twitter:title">
...
<meta name="csrf-token" content="wdcNpwkiBjGq_sPkDQXeP8aFuZRDWdOnI2DCli7pp4_2hL4J-wShohYIiK9uwt4_tv6PKTo69vHFqJ9QMYl5_A" />
<meta name="csp-nonce" />
...
<li class="breadcrumb-item">
<a href="/archlinux/packaging/packages/glibc/-/blob/main/sdt.h?ref_type=heads"><strong>sdt.h</strong>
</a></li>
</ul>
</div>
...
<a class="gl-button btn btn-md btn-default js-blob-blame-link" href="/archlinux/packaging/packages/glibc/-/blame/main/sdt.h?ref_type=heads"><span class="gl-button-text">
Blame
</span>

</a>
<a class="gl-button btn btn-md btn-default " href="/archlinux/packaging/packages/glibc/-/commits/main/sdt.h?ref_type=heads"><span class="gl-button-text">
History
</span>

</a>
<a aria-keyshortcuts="y" class="gl-button btn btn-md btn-default has-tooltip js-data-file-blob-permalink-url" data-html="true" title="Go to permalink &lt;kbd class=&#39;flat ml-1&#39; aria-hidden=true&gt;y&lt;/kbd&gt;" href="/archlinux/packaging/packages/glibc/-/blob/8b1b69f8277555257a0ec9681b90dcd9bd6faabd/sdt.h"><span class="gl-button-text">
Permalink
</span>
...
<div data-blob-path="sdt.h" data-branch="main" data-branch-rules-path="/archlinux/packaging/packages/glibc/-/settings/repository#js-branch-rules" data-project-path="archlinux/packaging/packages/glibc" id="js-code-owners"></div>

</div>
<div class="blob-content-holder js-per-page" data-blame-per-page="1000" id="blob-content-holder">
<div data-blob-path="sdt.h" data-explain-code-available="false" data-new-workspace-path="/-/remote_development/workspaces/new" data-original-branch="main" data-project-path="archlinux/packaging/packages/glibc" data-ref-type="heads" data-resource-id="gid://gitlab/Project/34175" data-target-branch="main" data-user-id="" id="js-view-blob-app">
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/archlinux/packaging/packages/glibc/edit/main/-/sdt.h'
